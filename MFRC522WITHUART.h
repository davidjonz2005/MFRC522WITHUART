 ...
 */
#ifndef MFRCWITHUART_h
#define MFRCWITHUART_h
...
public:
	...
	/////////////////////////////////////////////////////////////////////////////////////
	MFRC522WITHUART(byte resetPowerDownPin,HardwareSerial *Serial) ;
	...
	bool PCD_WriteRegister(byte reg, byte count, byte *values);
